...
export default function GeneratePasswordComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-600 dark:bg-gray-900">
      {/* Center the password generator card within the screen */}
      <Card className="w-full max-w-md p-6 bg-gray-300 dark:bg-gray-800 shadow-lg rounded-lg">
